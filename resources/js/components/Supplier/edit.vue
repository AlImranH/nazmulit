                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            Update Supplier
                            <router-link to="/supplier" class="btn btn-primary btn-sm float-end">All Suppler</router-link>
                        </div>
                        <div class="card-body mt-3">
                            <form class="row g-3" @submit.prevent="updateSupplier" enctype="multipart/form-data">
                                <div class="col-md-4">
...
export default{
    ...
    methods:{
        getSupplier(supplierId){
            axios.get('/api/supplier/'+supplierId)
            .then(res => {
                this.form = res.data;
            })
            .catch(err => alert(err))
        ...
        updateSupplier(){
            axios.put('/api/supplier/update/'+this.supplierId, this.form)
            .then(
                res => {
